...
//     if (customerId) {
//       existingActiveAppointmentQuery.createdByUserId = customerId;
//     } else {
//       existingActiveAppointmentQuery.phone = finalPhone;
//     }
...
//     await appt.save();
//     await notifyAppointmentUpdated(appt);
//     res.json(appt);
//   } catch (e) {
//     res.status(500).json({ message: e.message });
//   }
...
//     await notifyAppointmentDeleted(existing);
